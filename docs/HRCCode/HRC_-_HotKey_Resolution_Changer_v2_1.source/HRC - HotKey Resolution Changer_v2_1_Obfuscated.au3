...
Local $1s = DllCall("kernel32.dll", "dword", "GetLastError")
...
Local $1s = DllCall("user32.dll", $27, "SendMessageW", "hwnd", $20, "uint", $21, $25, $22, $26, $23)
...
Func _6($2i, $2j, $22, $23)
Local $1s = DllCall("user32.dll", "lresult", "CallNextHookEx", "handle", $2i, "int", $2j, "wparam", $22, "lparam", $23)
If @error Then Return SetError(@error, @extended, -1)
Return $1s[0]
EndFunc
Func _7($2k)
Local $1s = DllCall("gdi32.dll", "bool", "DeleteObject", "handle", $2k)
If @error Then Return SetError(@error, @extended, False)
Return $1s[0]
EndFunc
Func _8($20, $2l = True)
Local $1s = DllCall("user32.dll", "bool", "EnableWindow", "hwnd", $20, "bool", $2l)
If @error Then Return SetError(@error, @extended, False)
Return $1s[0]
EndFunc
Func _9($20)
If Not IsHWnd($20) Then $20 = GUICtrlGetHandle($20)
Local $1s = DllCall("user32.dll", "int", "GetClassNameW", "hwnd", $20, "wstr", "", "int", 4096)
If @error Then Return SetError(@error, @extended, False)
Return SetExtended($1s[0], $1s[2])
EndFunc
Func _a()
Local $1s = DllCall("kernel32.dll", "dword", "GetCurrentThreadId")
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _b()
Local $1s = DllCall("user32.dll", "hwnd", "GetFocus")
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _c($2m)
...
$2n = "ptr"
EndIf
Local $1s = DllCall("kernel32.dll", "handle", "GetModuleHandleW", $2n, $2m)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _d($20, $2o)
...
Local $1s = DllCall("user32.dll", "bool", "InvalidateRect", "hwnd", $20, "struct*", $2t, "bool", $2u)
If @error Then Return SetError(@error, @extended, False)
Return $1s[0]
EndFunc
Func _f($2v, $2w, $2x)
...
EndFunc
Func _g($2y)
Local $1s = DllCall("user32.dll", "uint", "RegisterWindowMessageW", "wstr", $2y)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _h($2z, $30, $31, $32 = 0)
Local $1s = DllCall("user32.dll", "handle", "SetWindowsHookEx", "int", $2z, "ptr", $30, "handle", $31, "dword", $32)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _i($2i)
Local $1s = DllCall("user32.dll", "bool", "UnhookWindowsHookEx", "handle", $2i)
If @error Then Return SetError(@error, @extended, False)
Return $1s[0]
EndFunc
...
Func _t($20, $42, $43 = 0)
Local $1s = DllCall("comctl32.dll", "int", "ImageList_Add", "handle", $20, "handle", $42, "handle", $43)
If @error Then Return SetError(@error, @extended, -1)
Return $1s[0]
EndFunc
...
$2v = BitOR($2v, $4a[$46])
Local $1s = DllCall("comctl32.dll", "handle", "ImageList_Create", "int", $44, "int", $45, "uint", $2v, "int", $48, "int", $49)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _v($20)
Local $1s = DllCall("comctl32.dll", "bool", "ImageList_Destroy", "handle", $20)
If @error Then Return SetError(@error, @extended, False)
Return $1s[0] <> 0
EndFunc
Global $4b = False
...
If $4v[$53][7] = 0 Then
DllCall('user32.dll', 'int', 'PostMessage', 'hwnd', $4v[0][10], 'uint', $4u, 'int', $53, 'int', 0xAFAF)
Else
DllCall('user32.dll', 'int', 'SendMessage', 'hwnd', $4v[0][10], 'uint', $4u, 'int', $53, 'int', 0xAFAF)
EndIf
EndIf
EndFunc
Func _14($54)
Local $55 = DllCall('user32.dll', 'short', 'GetAsyncKeyState', 'int', $54)
...
DllCall('user32.dll', 'int', 'keybd_event', 'int', $54, 'int', 0, 'int', 2, 'ptr', 0)
...
EndFunc
Func _1k()
Local $55 = DllCall('user32.dll', 'short', 'GetAsyncKeyState', 'int', 0)
If @error Then
Return SetError(1, 0, 0)
Else
...
Local $55 = DllCall('user32.dll', 'ptr', 'SetWinEventHook', 'uint', $5q, 'uint', $5r, 'ptr', 0, 'ptr', $5s, 'dword', $5t, 'dword', $5n, 'uint', $2v)
...
EndFunc
Func _1o($5j)
Local $55 = DllCall('user32.dll', 'int', 'UnhookWinEvent', 'ptr', $5j)
If(@error) Or(Not $55[0]) Then
Return SetError(1, 0, 0)
EndIf
Return 1
...
$55 = DllCall('kernel32.dll', 'int', 'GetVersionExW', 'ptr', DllStructGetPtr($5u))
If(@error) Or(Not $55[0]) Then
Return SetError(1, 0, 0)
EndIf
...
Local $55 = DllCall('ntdll.dll', 'uint', 'RtlDecompressBuffer', 'ushort', $3e, 'ptr', $6c, 'ulong', $6d, 'ptr', $6e, 'ulong', $6f, 'ulong*', 0)
If @error Then
Return SetError(1, 0, 0)
Else
If $55[0] Then
...
EndFunc
Func _1t($2j)
DllCall('kernel32.dll', 'none', 'FatalExit', 'int', $2j)
EndFunc
Func _1u($6g)
...
Local $55
If Not $63 Then
$55 = DllCall('kernel32.dll', 'ptr', 'HeapCreate', 'dword', 0, 'ulong_ptr', 0, 'ulong_ptr', 0)
If(@error) Or(Not $55[0]) Then
_1v(1, 'Error allocating memory.')
EndIf
$63 = $55[0]
EndIf
$55 = DllCall('kernel32.dll', 'ptr', 'HeapAlloc', 'ptr', $63, 'dword', 0x00000008, 'ulong_ptr', $6h)
If(@error) Or(Not $55[0]) Then
If $6b Then
_1v(1, 'Error allocating memory.')
EndIf
...
Return SetError(1, 0, 0)
EndIf
Local $55 = DllCall('kernel32.dll', 'int', 'HeapFree', 'ptr', $63, 'dword', 0, 'ptr', $6g)
If(@error) Or(Not $55[0]) Then
...
EndIf
$55 = DllCall('kernel32.dll', 'ptr', 'HeapReAlloc', 'ptr', $63, 'dword', 0x00000008, 'ptr', $6g, 'ulong_ptr', $6h)
If(@error) Or(Not $55[0]) Then
If $6b Then
_1v(1, 'Error allocating memory.')
EndIf
...
Return SetError(1, 0, 0)
EndIf
Local $55 = DllCall('kernel32.dll', 'ulong_ptr', 'HeapSize', 'ptr', $63, 'dword', 0, 'ptr', $6g)
...
Return SetError(1, 0, 0)
EndIf
Local $55 = DllCall('kernel32.dll', 'int', 'HeapValidate', 'ptr', $63, 'dword', 0, 'ptr', $6g)
If @error Then
Return SetError(2, 0, 0)
EndIf
Return $55[0]
...
Local $55 = DllCall('kernel32.dll', 'int', 'GetVersionExW', 'ptr', DllStructGetPtr($5u))
If(@error) Or(Not $55[0]) Then
Return SetError(1, 0, 0)
EndIf
...
Func _23($3r, $2v = 0)
Local $1s = DllCall("kernel32.dll", "handle", "GlobalAlloc", "uint", $2v, "ulong_ptr", $3r)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _24($7s)
Local $1s = DllCall("kernel32.dll", "ptr", "GlobalLock", "handle", $7s)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _25($7s)
Local $1s = DllCall("kernel32.dll", "bool", "GlobalUnlock", "handle", $7s)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _26($7t, $6h, $7u, $7v)
Local $1s = DllCall("kernel32.dll", "ptr", "VirtualAlloc", "ptr", $7t, "ulong_ptr", $6h, "dword", $7u, "dword", $7v)
If @error Then Return SetError(@error, @extended, 0)
Return $1s[0]
EndFunc
Func _27($7t, $6h, $7w)
Local $1s = DllCall("kernel32.dll", "bool", "VirtualFree", "ptr", $7t, "ulong_ptr", $6h, "dword", $7w)
If @error Then Return SetError(@error, @extended, False)
Return $1s[0]
EndFunc
...
_25($bf)
$1s = DllCall("ole32.dll", "int", "CreateStreamOnHGlobal", "handle", $bg, "int", True, "ptr*", 0)
...
DllCall("oleaut32.dll", "long", "DispCallFunc", "ptr", $bi, "dword", 8 + 8 * @AutoItX64, _
...
$bn = DllCall('gdi32.dll', 'ptr', 'CreateDIBSection', 'hwnd', 0, 'ptr', DllStructGetPtr($bl), 'uint', 0, 'ptr*', 0, 'ptr', 0, 'dword', 0)
If(Not @error) And($bn[0]) Then
DllCall('gdi32.dll', 'dword', 'SetBitmapBits', 'ptr', $bn[0], 'dword', $55[2] * $55[3] * 4, 'ptr', DllStructGetData($3f, 'Scan0'))
$bn = $bn[0]
Else
$bn = 0
EndIf
...
Local $bw = DllCall("Crypt32.dll", "int", "CryptStringToBinary", "str", $bu, "int", 0, "int", 1, "ptr", 0, "ptr", DllStructGetPtr($bv, 1), "ptr", 0, "ptr", 0)
If @error Or Not $bw[0] Then Return SetError(1, 0, "")
Local $bx = DllStructCreate("byte[" & DllStructGetData($bv, 1) & "]")
$bw = DllCall("Crypt32.dll", "int", "CryptStringToBinary", "str", $bu, "int", 0, "int", 1, "ptr", DllStructGetPtr($bx), "ptr", DllStructGetPtr($bv, 1), "ptr", 0, "ptr", 0)
...
If @error Then Return $c5
Local $ca = DllCall("user32.dll", "handle", "GetDC", "hwnd", $20)
If @error Then Return $c5
$ca = $ca[0]
Local $cb = DllCall("gdi32.dll", "int", "GetDeviceCaps", "handle", $ca, "int", 90)
If Not @error Then
$cb = $cb[0]
$c5[0] = Int(2 *(.25 - DllStructGetData($c8, 1) * 72 / $cb)) / 2
EndIf
DllCall("user32.dll", "int", "ReleaseDC", "hwnd", $20, "handle", $ca)
...
$55 = DllCall("user32.dll", "lparam", "SendMessage", "hwnd", $20, "int", $1b, "wparam", 0, "lparam", DllStructGetPtr($cg))
...
EndFunc
Func _3a($cs, $ct, $cu)
Local $ax = DllCall('user32.dll', "int", "SetDlgItemText", _
"hwnd", $cs, _
"int", $ct, _
"str", $cu)
Return $ax[0]
