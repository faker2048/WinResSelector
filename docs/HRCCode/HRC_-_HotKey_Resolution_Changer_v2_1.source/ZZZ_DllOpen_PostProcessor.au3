...
$sFile = @ScriptDir & "\HRC - HotKey Resolution Changer_v2_1_Obfuscated.au3"
...
#cs
	_ArrayDisplay($aDllOpen_Calls)
	MsgBox(0, "", StringLen($aDllOpen_Calls[1][0]))
	Exit
#ce
...
;MsgBox(0,"",@ScriptDir & "\" & StringReplace($sFile, ".au3", "_pp.au3"))
